...
| Tracked files / bytes | 124 files, ~1.3 MB | `[E]` |
...
```bash
./scripts/validate-crew.sh            # 51 structural assertions
./scripts/run-crew-tests.sh           # 190 crew assertions
