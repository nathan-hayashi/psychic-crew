...
| Tracked files / bytes | 126 files, ~1.3 MB | `[E]` |
...
```bash
./scripts/validate-crew.sh            # 53 structural assertions
./scripts/run-crew-tests.sh           # 203 crew assertions
