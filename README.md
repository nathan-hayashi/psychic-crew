...
| Tracked files / bytes | 188 files, ~2.3 MB | `[E]` |
...
```bash
./scripts/validate-crew.sh            # 59 structural assertions
./scripts/run-crew-tests.sh           # 270 crew assertions
...
SubagentStop -> continuity."subagent-stop.sh": *
UserPromptSubmit -> continuity."user-prompt-submit.sh": *
PermissionRequest -> continuity."permission-request.sh": *
