# MASTER_FIFO_PLAN_CLAUDE.md — v3.11 (psychic-crew canonical edition; R-CH-1: the upstream web channel is retired — this file is authored HERE now, under its own gate)
