...
Live numbers (post-CLEANUP-1): crew suite **338 PASS / 0 FAIL** · validate-crew **60 PASS / 0 SKIP / 0 FAIL** · save-context **33 PASS / 0 FAIL** · app suite **18/18** · corrections **28 rows across 28 registered correction IDs** · portability drill **PORTABLE** · **229 tracked files**.
...
54/0/0 · 33/0 · matrices 27/0/15 · envelope 11/0 · PORTABLE · 229 tracked · v3.20/D35;
