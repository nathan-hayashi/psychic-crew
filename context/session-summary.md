...
Live numbers (post-CLEANUP-1): crew suite **181 PASS / 0 FAIL** · validate-crew **50 PASS / 1 SKIP / 0 FAIL** · save-context **30 PASS / 0 FAIL** · app suite **18/18** · corrections **28 rows across 28 registered correction IDs** · portability drill **PORTABLE** · **100 tracked files**.
