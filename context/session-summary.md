...
Live numbers (post-CLEANUP-1): crew suite **190 PASS / 0 FAIL** · validate-crew **51 PASS / 0 SKIP / 0 FAIL** · save-context **33 PASS / 0 FAIL** · app suite **18/18** · corrections **28 rows across 28 registered correction IDs** · portability drill **PORTABLE** · **124 tracked files**.
