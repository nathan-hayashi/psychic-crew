...
Live numbers (post-S4): crew suite **157 PASS / 0 FAIL** · validate-crew **42 PASS / 1 SKIP / 0 FAIL** · save-context **23 PASS / 0 FAIL** · app suite **18/18** · corrections **22 rows across 25 registered correction IDs** · portability drill **PORTABLE** · **87 tracked files**.
